...
note. We apply pivot_longer( ) to make the dataset more readable with
time and ratio obviously shown. It totally has 2435 observations (where
an id has 5 rows) and 3 variables. It contains key variables such as id,
time and ratio.
