...
note. It totally has 487 observations and 6 variables. It contains key
variables such as ratio changing along 0(which is baseline), 2, 4, 6, 8
years.
...
There are 471 participants appear in both dataset. The result table
