...
base_mean_age = mean(pull(mci_baseline, current_age))

base_mean_age_mci = mean(pull(mci_base_new, current_age))
```

For recruited participants, the average baseline age is 65.0467909. For
those develop MCI, the average baseline age is 65.6113402.
