...
``` r
# load the dataset, choose the range to skip the figure in the first row
Professor = read_excel("202207 Trash Wheel Collection Data.xlsx", sheet = 'Professor Trash Wheel', range = "A2:M96")
...
``` r
# load the dataset, choose the range to skip the figure in the first row
Gwynnda = read_excel("202207 Trash Wheel Collection Data.xlsx", sheet = 'Gwynnda Trash Wheel', range = "A2:K108")
...
``` r
# export the result
write.csv(combined_dataset, file = "combined dataset.csv", row.names = T)
```
