...
The proportion of women in the study who are APOE4 carriers is `r num_carrier_female/nrow(mci_base_new)` .
...
For this dataset, we also need to skip the first row since it's also note.
