...
There are `r nrow(combined_dataset)/5` participants appear in both dataset, each participants have 5 rows data (year 0 - year 8), which means total `r nrow(combined_dataset)` in the combined dataset. It has `r ncol(combined_dataset)` variables. The result table contains the information of the participant's id, age, sex, education, apoe4 status, MCI development, change based on time.
