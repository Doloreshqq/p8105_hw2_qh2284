...
For recruited participants, the average baseline age is `r mean(pull(mci_baseline, current_age))`. For those develop MCI, the average baseline age is `r mean(pull(mci_base_new, current_age))`.
